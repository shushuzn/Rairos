...
class ConfidenceScorer:
    ...
    def score_novelty(self, gap: ResearchGapV2, known_gaps: List[ResearchGapV2]) -> float:
    ...
    def score_support(self, gap: ResearchGapV2) -> float:
    ...
    def filter_gaps(
        ...
        known_gaps: List[ResearchGapV2],
        prior: float = None,
    ) -> tuple[List[ResearchGapV2], List[ResearchGapV2]]:
        """Filter gaps into high-quality and low-quality buckets.

        Returns (accepted_gaps, suppressed_gaps).
        """
        accepted: List[ResearchGapV2] = []
        suppressed: List[ResearchGapV2] = []
    ...
    def get_quality_summary(self, gaps: List[ResearchGapV2]) -> Dict[str, Any]:
