...
use crate::{
    CacheAction, DedupAction, EvoSkillAction, InsightAction, Jin10Action,
    NarrativeAction, QuestionAction, RagAction,
...
/// Handle `chat-tui` — full-screen TUI chat with paper context.
///
/// Simplified ratatui-based TUI: message area + input bar.
