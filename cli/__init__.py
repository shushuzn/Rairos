...
_LAZY_EXPORTS = {
    ...
    "_run_doctor": ("cli.cmd.doctor", "_run_doctor"),
    "_build_doctor_parser": ("cli.cmd.doctor", "_build_doctor_parser"),
    ...
    "_run_daemon": ("cli.cmd.daemon", "_run_daemon_start"),
    "_run_scout": ("cli.cmd.scout", "_run_scout"),
    "_run_intel": ("cli.cmd.intel", "_run_intel"),
    "_run_signal": ("cli.cmd.signal", "_run_signal"),
    "_run_discover": ("cli.cmd.discover", "_run_discover"),
