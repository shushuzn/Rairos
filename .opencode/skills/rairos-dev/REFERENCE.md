...
- **~73k+ Rust lines**
- **123 CLI commands**
- **86 MCP tools** (46 core + 40 LLM-backed)
- **License**: GPL-3.0
...
| rairos-mcp | MCP protocol server (86 tools) |
