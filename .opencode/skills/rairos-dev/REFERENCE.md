...
- **~73k+ Rust lines**
- **123 CLI commands**
- **88 MCP tools** (48 core + 40 LLM-backed)
- **License**: GPL-3.0
...
| rairos-mcp | MCP protocol server (88 tools) |
