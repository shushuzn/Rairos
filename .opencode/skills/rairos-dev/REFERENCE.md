...
- **~73k+ Rust lines**
- **123 CLI commands**
- **84 MCP tools** (44 core + 40 LLM-backed)
- **License**: GPL-3.0
...
| rairos-mcp | MCP protocol server (84 tools) |
