...
- **~73k+ Rust lines**
- **123 CLI commands**
- **70 MCP tools** (30 core + 40 LLM-backed)
- **License**: GPL-3.0
...
| rairos-mcp | MCP protocol server (70 tools) |
...
**Core Rust (30)**: paper_search, paper_ingest, tag_add, tag_remove, tag_list, trends_detect_trending, paper_recommend, citation_graph, paper_query, paper_chat, kg_paper_subgraph, kg_tag_graph, kg_full_graph, kg_query, pdf_download, pdf_extract_text, pdf_extract_structured, trends_predict_next, trends_top_predictions, trends_compare_tags, cite_fetch, paper_search_multi, paper_lookup_doi, paper_citations, chart_query, paper_parse_full, replication_check_simple, github_repo_metadata, huggingface_dataset_metadata, pdf_extract_advanced
