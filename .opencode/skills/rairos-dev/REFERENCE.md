...
- **~73k+ Rust lines**
- **123 CLI commands**
- **85 MCP tools** (45 core + 40 LLM-backed)
- **License**: GPL-3.0
...
| rairos-mcp | MCP protocol server (85 tools) |
