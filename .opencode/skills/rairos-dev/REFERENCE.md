...
- **~73k+ Rust lines**
- **123 CLI commands**
- **81 MCP tools** (41 core + 40 LLM-backed)
- **License**: GPL-3.0
...
| rairos-mcp | MCP protocol server (81 tools) |
